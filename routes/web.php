...
# GUEST EMAIL
Route::get('/concern', [ConcernController::class, 'show'])->name('concern.index');
Route::post('concerns', [ConcernController::class, 'store'])->name('concern.store');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('gallery', [TemplateController::class, 'gallery'])->name('templates.gallery');
    Route::get('blog-grid', [TemplateController::class, 'grid'])->name('templates.grid');
    Route::get('blog-list', [TemplateController::class, 'list'])->name('templates.list');
    ...
    #Pagination
    Route::get('pagination/fetch_data', [TemplateController::class, 'fetch_data'])->name('templates.fetch_data');
    Route::get('pagination/fetch_list_data', [TemplateController::class, 'fetch_list_data'])->name('templates.fetch_list_data');
    Route::get('pagination/fetch_grid_data', [TemplateController::class, 'fetch_grid_data'])->name('templates.fetch_grid_data');
    Route::get('pagination/fetch_gallery_banner_data', [TemplateController::class, 'fetch_gallery_banner_data'])->name('templates.fetch_gallery_banner_data');
    Route::get('pagination/fetch_gallery_logo_data', [TemplateController::class, 'fetch_gallery_logo_data'])->name('templates.fetch_gallery_logo_data');
    Route::get('pagination/fetch_gallery_logo_list_data', [TemplateController::class, 'fetch_gallery_logo_list_data'])->name('templates.fetch_gallery_logo_list_data');
    Route::get('pagination/fetch_gallery_banner_list_data', [TemplateController::class, 'fetch_gallery_banner_list_data'])->name('templates.fetch_gallery_banner_list_data');
    Route::get('pagination/fetch_data_more', [HomeController::class, 'fetch_data_more'])->name('templates.fetch_data_more');
    Route::get('pagination/fetch_data_category', [CategoryController::class, 'fetch_data_category'])->name('categories.fetch_data_category');
    Route::get('pagination/fetch_sent_data', [MailController::class, 'fetch_sent_data'])->name('emails.fetch_sent_data');
    Route::get('pagination/fetch_inbox_data', [MailController::class, 'fetch_inbox_data'])->name('emails.fetch_inbox_data');
    Route::get('pagination/fetch_permission_data', [PermissionController::class, 'fetch_permission_data'])->name('permissions.fetch_permission_data');
    Route::get('pagination/fetch_data_role', [RoleController::class, 'fetch_data_role'])->name('roles.fetch_data_role');
    Route::get('pagination/fetch_user_data', [UserController::class, 'fetch_user_data'])->name('users.fetch_user_data');
    Route::get('pagination/fetch_data_advertisement', [AdvertisementController::class, 'fetch_data_advertisement'])->name('advertisements.fetch_data_advertisement');
    Route::get('pagination/fetch_data_category', [CategoryController::class, 'fetch_data_category'])->name('categories.fetch_data_category');
    Route::get('pagination/fetch_notif_data', [NotificationController::class, 'fetch_notif_data'])->name('notifications.fetch_notif_data');
    ...
    Route::delete('emails/inbox/{id}', [MailController::class, 'destroyInbox'])->name('emails.destroyInbox');
    Route::delete('emails/sent-mail/{id}', [MailController::class, 'destroyInbox'])->name('emails.destroyInbox');

    Route::get('emails', [MailController::class, 'index'])->name('emails.index');
    Route::get('emails/inbox', [MailController::class, 'inbox'])->name('emails.inbox');
    Route::get('emails/sent-mail', [MailController::class, 'sent'])->name('emails.sent-mail');
    Route::get('emails/draft', [MailController::class, 'draft'])->name('emails.draft');
    Route::get('emails/trash', [MailController::class, 'trash'])->name('emails.trash');
    ...
    Route::get('pagination/show_pagination', [UserController::class, 'show_pagination'])->name('users.show_paginate');

    Route::get('permissions', [PermissionController::class, 'index'])->name('permissions.index');
  

    Route::get('permissions/create', [PermissionController::class, 'create'])->name('permissions.create');
    Route::post('permissions', [CategoryController::class, 'store'])->name('permissions.store');
    ...
    Route::get('advertisements/create', [AdvertisementController::class, 'create'])->name('ads.create');
