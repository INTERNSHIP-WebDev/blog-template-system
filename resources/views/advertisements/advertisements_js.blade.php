...
<script>
    $(document).ready(function() {
        ...
        function filterByDateRange(start_date, end_date) {
            ...
            $.ajax({
                url: "{{ route('filter.advertisement') }}",
                method: "GET",
                data: {
        ...
        function advertisement(page, search_string, start_date, end_date) {
            $.ajax({
                url: "/pagination/paginate-data-advertisement?page=" + page,
                data: {
        ...
        $(document).on('click', '.pagination a', function(e) {
            ...
            advertisement(page, search_string, start_date, end_date);
        });
        ...
        $(document).on('keyup', '#searchInput', function(e) {
            ...
            let start_date = $('#start_date').val();
            let end_date = $('#end_date').val();
            advertisement(1, search_string, start_date, end_date);
        });
    });
</script>
<!-- Today Button -->
...
<script>
    ...
    function refreshTable() {
        $.ajax({
            url: "{{ route('paginate.advertisement') }}", // Replaced with the actual route for retrieving the table content
            method: "GET",
            success: function(res) {
                $('.table-data').html(res);
            }
