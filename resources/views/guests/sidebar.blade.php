                ...
                <div class="nav-content">
                    ...
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        <ul class="mb-1 top-content">
                            ...
                            <li><a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"class="nav-content-bttn open-font" ><i class="feather-log-out btn-round-md bg-red-gradiant me-3"></i><span>Logout</span></a></li>                    
